...
tenkan_sen <- c(vector(mode = "numeric", length = 26), tenkan, vector(mode = "numeric", length = 26))
kijun_sen <- c(vector(mode = "numeric", length = 26), kijun, vector(mode = "numeric", length = 26))
senkou_span_B <- c(vector(mode = "numeric", length = 78), senkou_B)
senkou_span_A <- c(vector(mode = "numeric", length = 52), senkou_A)
